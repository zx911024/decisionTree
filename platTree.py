...
# decisionNode = dict(boxstyle="round4", color='g', fc='1')
decisionNode = dict(boxstyle="square", color='k', fc='1',pad=0.50)
#定义叶结点形状
leafNode = dict(boxstyle="round4", color='k',fc='1',pad=1.20)
#定义父节点指向子节点或叶子的箭头形状
# arrow_args = dict(arrowstyle="<-", color='#B5A5FF',connectionstyle="arc3,rad=.05")
arrow_args = dict(arrowstyle="<-", color='k')
...
if __name__=='__main__':
    ...
    tree_dict = {'换手率': {'低': '振动', '高': {'成交方向': {'卖出': {'成交总量': {'大': '下跌', '小': '振动'}}, '买入': {'活跃度': {'活跃': '上涨', '不活跃': '振动'}}}}}}
